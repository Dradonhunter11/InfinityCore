...
{ 
    public static class PotsRegistery
    {
        /// <summary>
        /// key = Tiles<br />
        /// Value = Pots style
        ...
        {
            RegisterDefaultsPotsDrop(PotsTypeID.Surface);
            RegisterDefaultsPotsDrop(PotsTypeID.Ice);
            RegisterDefaultsPotsDrop(PotsTypeID.Jungle);
            RegisterDefaultsPotsDrop(PotsTypeID.Dungeon);
            RegisterDefaultsPotsDrop(PotsTypeID.Hell);
            RegisterDefaultsPotsDrop(PotsTypeID.Corrupt);
            RegisterDefaultsPotsDrop(PotsTypeID.SpiderCave);
            RegisterDefaultsPotsDrop(PotsTypeID.Crimson);
            RegisterDefaultsPotsDrop(PotsTypeID.Pyramid);
            RegisterDefaultsPotsDrop(PotsTypeID.Lihzahrd);
            RegisterDefaultsPotsDrop(PotsTypeID.Marble);
        }

        public static void RegisterDefaultsPotsDrop(PotsTypeID type)
        {
            RegisterDefaultsPotsDrop((int)type);
        }

        public static void RegisterDefaultsPotsDrop(int type)
        {
            ...
            {
                RegisterPotsDrop(type, new ItemPotsDrop("GoldenKey", ItemID.GoldenKey, 1, (int x, int y) => Terraria.WorldGen.genRand.Next(40) == 0 && (double)y > Main.worldSurface));
            }
            RegisterPotsDrop(type, new LayerBasedItemsPotsDrop("Potion",
                ...
                (i, i1) => Terraria.WorldGen.genRand.Next(45) == 0 || (Main.rand.Next(45) == 0 && Main.expertMode)));
        ...
        public static void ExecuteDrop(int x, int y, int potsType)
        {
            ...
            for (int k = num; k < num + 2; k++) {
                ...
                if (!Terraria.WorldGen.SolidTile2(k, num2 + 2))
                    flag = true;
            }
