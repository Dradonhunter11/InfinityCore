...
{
    class AdvancedUIPanel : UIElement
    {
        ...
        public AdvancedUIPanel(Texture2D texture)
        {
        ...
        public AdvancedUIPanel(Texture2D texture, int cornerSize, int barSize)
        {
            if (_backgroundTexture == null)
            {
                _backgroundTexture = texture;
        ...
        protected override void DrawSelf(SpriteBatch spriteBatch)
        {
            if (isVisible)
            {
                this.DrawPanel(spriteBatch, _backgroundTexture, backgroundColor);
            }
        }
    }
}
